<header id="header" class="transparent-header full-header" data-sticky-class="not-dark">
    ...
    <div id="header-wrap">
        ...
        <div class="container clearfix">
            ...
            ============================================= -->
            <div id="logo">
                <a href="index.php" class="standard-logo" data-dark-logo="images/"><img src="images/" alt="Wisata Indonesia"></a>
                <a href="index.php" class="retina-logo" data-dark-logo="images/"><img src="images/" alt="Wisata Indonesia"></a>
            </div><!-- #logo end -->
