...
<head>
    ...
    <!-- Document Title
    ============================================= -->
    <title>Daftar Tempat | Wisata Indonesia</title>
...
<div id="wrapper" class="clearfix">
    ...
    <section id="page-title">
        ...
        <div class="container clearfix">
            ...
            <ol class="breadcrumb">
                <li><a href="#">Home</a></li>
                <li class="active">Daftar Tempat</li>
            </ol>
        </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <select style="width: 80pt;" id="action-tempat" name="action-tempat" class="select-hide form-control bottommargin-sm">
                                    ...
                                    <option value="edit-tempat" data-tempat="<?php echo $tampil['id']; ?>" data-nama="<?php echo $tampil['nama']; ?>">Ubah Tempat</option>
                                    <option value="hapus-produk" data-tempat="<?php echo $tampil['id']; ?>" data-nama="<?php echo $tampil['nama']; ?>">Hapus Tempat</option>
                                </select>
                            </td>
                        </tr>
                        <?php }?>
...
<script>
    ...
    $(".select-hide").change(function () {
        ...
        switch (value){
            case "edit-tempat":
                location.replace('tambah-tempat.php?ubah='+data_tempat);
                break;
            case "hapus-produk":
